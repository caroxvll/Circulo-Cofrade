...
class SemanaSantaTopicsPanel extends ConsumerStatefulWidget {
  const SemanaSantaTopicsPanel({
    super.key,
  ...
  @override
  ConsumerState<SemanaSantaTopicsPanel> createState() =>
      _SemanaSantaTopicsPanelState();
}

class _SemanaSantaTopicsPanelState extends ConsumerState<SemanaSantaTopicsPanel> {
  var _showAll = false;
  ...
  Widget build(BuildContext context) {
    ...
    return topicsAsync.when(
      ...
      data: (topics) {
        final community = semanaSantaCommunityTopics(topics);
        ...
        return Column(
          ...
          children: [
            ...
            Text(
              'Horarios, itinerarios y tertulia cofrade',
              ...
              child: Column(
                ...
                children: [
                  if (community.isEmpty) ...[
                    ...
                    Text(
                      'Aún no hay temas. Pulsa «Tema» arriba para abrir el primero.',
...
class _SsHubTopicRow extends StatelessWidget {
  const _SsHubTopicRow({
    required this.topic,
    required this.forumId,
    required this.onTap,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        const SizedBox(width: 10),
        Text(topic.timeAgo, style: style),
      ],
    );
  }
}

Future<void> openSemanaSantaTopicCompose(
  ...
  return showTopicComposeSheet(
    ...
    ref,
    forumId: forumId,
    seasonKey: semanaSantaSeasonKey,
  );
}
