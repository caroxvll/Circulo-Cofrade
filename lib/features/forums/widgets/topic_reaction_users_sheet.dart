...
final topicReactionUsersProvider =
  ...
  return repo.fetchReactionUsers(topicId);
});

Future<void> showTopicReactionUsersSheet(
  ...
  return showModalBottomSheet<void>(
    ...
    builder: (context) => _TopicReactionUsersSheet(
      topicId: topicId,
...
class _TopicReactionUsersSheet extends ConsumerWidget {
  const _TopicReactionUsersSheet({
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final usersAsync = ref.watch(topicReactionUsersProvider(topicId));
          ...
          children: [
            ...
            usersAsync.when(
              ...
              error: (_, __) => Padding(
                ...
                child: Text(
                  'No se pudo cargar la lista. ¿Ejecutaste forum_topic_reactions.sql?',
