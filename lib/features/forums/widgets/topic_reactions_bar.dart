...
import 'topic_reaction_users_sheet.dart';

/// Reacciones del tema: solo se muestran las que tienen votos (+ botón para añadir).
class TopicReactionsBar extends StatefulWidget {
  const TopicReactionsBar({
    super.key,
  ...
  @override
  State<TopicReactionsBar> createState() => _TopicReactionsBarState();
}

class _TopicReactionsBarState extends State<TopicReactionsBar> {
  ...
  @override
  void didUpdateWidget(TopicReactionsBar oldWidget) {
...
/// Pill compartido (tema / respuestas).
class ForumReactionPill extends StatelessWidget {
  const ForumReactionPill({
    super.key,
    required this.emoji,
    required this.label,
    required this.count,
  ...
  static const _emojiStyleCompact = TextStyle(
    fontSize: 13,
    height: 1,
    fontFamily: 'Segoe UI Emoji',
    fontFamilyFallback: [
              ...
              Material(
                ...
                child: InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      emoji,
                      style: (compact ? _emojiStyleCompact : _emojiStyle)
                          .copyWith(
