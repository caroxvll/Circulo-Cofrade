...
class GloriasTopicsPanel extends ConsumerStatefulWidget {
  const GloriasTopicsPanel({
    super.key,
  ...
  @override
  ConsumerState<GloriasTopicsPanel> createState() =>
      _GloriasTopicsPanelState();
}

class _GloriasTopicsPanelState extends ConsumerState<GloriasTopicsPanel> {
  var _showAll = false;
  ...
  Widget build(BuildContext context) {
    ...
    return topicsAsync.when(
      ...
      data: (topics) {
        final community = gloriasCommunityTopics(topics);
...
class _GloriasHubTopicRow extends StatelessWidget {
  const _GloriasHubTopicRow({
    required this.topic,
    required this.forumId,
    required this.onTap,
  });
...
Future<void> openGloriasTopicCompose(
